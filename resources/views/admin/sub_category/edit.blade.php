...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{__('messages.edit', ['name' => 'SubCategory'])}}</h1>
            <!--end::Title-->
            ...
            <div class="card-body p-lg-17">
                ...
                <div class="position-relative mb-17">
                    ...
                    <div class="overlay overlay-show">
                        <!--begin::Title-->
                        <h3 class="fs-2qx fw-bolder mb-3 m">{{__('messages.edit', ['name' => 'SubCategory'])}}</h3>
                        <!--end::Title-->
                    </div>
                    <!--end::Overlay-->
                </div>
                ...
                <div class="d-flex flex-column flex-lg-row mb-17">
                    ...
                    <div class="flex-lg-row-fluid me-0 me-lg-20">
                        ...
                        <!--begin::Form-->
                        {!! Form::model($sub_category, ['method' => 'PATCH','route' => ['sub_categories.update', $sub_category->id], 'class' => 'form mb-15', 'enctype'=>'multipart/form-data']) !!}
                        @csrf
