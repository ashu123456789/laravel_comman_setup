...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{__('messages.list', ['name' => 'Role'])}}</h1>
            <!--end::Title-->
        ...
        <div class="d-flex align-items-center py-1">
            <!--begin::Button-->
            <a href="{{ route('roles.create') }}" class="btn btn-sm btn-primary">{{__('messages.create', ['name' => 'Role'])}}</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label fs-3 bg-light-danger text-danger">{{ ++$i }}</div>
                                </div>
                                <!--end::Avatar-->
                            </td>
                            <!-- end::IndexRow -->
                            ...
                            <td>
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('roles.show',$role->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $role->name }} </a>
                                    <span>{{ $role->name }}</span>
                                </div>
                                <!--end::User details-->
                            </td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('roles.edit',$role->id) }}" class="menu-link px-3">{{__('content.edit_title')}}</a>
                                    </div>
                                    @endcan
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
