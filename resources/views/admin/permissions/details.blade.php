...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
            ...
            <!--begin::Breadcrumb-->
            {{ Breadcrumbs::render('permissions.show') }}
            <!--end::Breadcrumb-->
        </div>
        <!--end::Page title-->
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">{{__('messages.list', ['name' => 'Permission'])}}</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <label class="col-lg-4 col-form-label required fw-bold fs-6 form-control-lg form-control-solid">{{$permission->name}}</label>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
